...
public class UserServiceHystrixCommand extends HystrixCommand<ApiResponse> {

	private final RestTemplate restTemplate;
	private final String url;

	public UserServiceHystrixCommand(HystrixCommandGroupKey group, int timeout, RestTemplate restTemplate, String url) {
		super(group, timeout);
