...
public class TelephoneServiceHystrixCommand extends HystrixCommand<ApiResponse> {

	private final RestTemplate restTemplate;
	private final String url;

	public TelephoneServiceHystrixCommand(HystrixCommandGroupKey group, int timeout, RestTemplate restTemplate, String url) {
		super(group, timeout);
